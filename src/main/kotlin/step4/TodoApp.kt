 ...
 * auf die Inhalte unseres InputElements zuzugreifen.
 *
 ...
 * Hinweis. Es ist kein echtes Two-Way-Binding. Lediglich die Referenz auf das HTMLElement. Wollen wir es im Code
 * dynamisch halten, müssen wir uns was anderes überlegen, aber das kommt später...
 */
val TodoApp = FC<Props> {
     ...
     * Lass uns hier nun unseren onClick-Handler definieren, welcher den Wert des InputFields auf der Console aus gibt.
    ...
    div {
        ...
        /**
         * Button mit onclick-Handler anlegen. Tip: onclick erwartet einen MouseEventHandler.
         * Wir wollen unser addTodo aber nicht speziell als MouseEventHandler definieren, sondern soll allgemein
         * gültig sein. Wir können jedoch ein anonyme Implementierung an der Stelle wählen ;) onClick = {}
         * Der Funktionsparameter (das Event) wird in Kotlin automatisch als 'it' an die Funktion übergeben,
         * wenn man nichts anderes angibt und wenn es nur einer ist. Alternativ kann man den Parameter auch
         * explizit mit 'event ->' angeben.
         *
